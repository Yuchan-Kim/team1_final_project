...
import defaultProfile from '../../ham_asset/images/profile-fill.png'; // 새로 추가: 기본 프로필 이미지 import
...
const ProfileOptions = ({ profiles, selectedProfile, onSelect }) => {
    ...
    // 수정: handleProfileClick 함수를 useCallback으로 메모이제이션
