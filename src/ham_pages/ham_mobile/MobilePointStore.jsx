    ...
    return (
        <div className="hmk_mobile_home-wrap">
            ...
            <div className="hmk_mobile_pointstore">
                <div className="hmk_mobile_pointstore-sticky-container">
                    {/* 상단 포인트 표시 */}
            ...
            {isAlertOpen && (
                <div className="hmk_mobile_pointstore-alert-overlay">
                    <div className="hmk_mobile_pointstore-alert">
                        <div className="hmk_mobile_pointstore-alert-content">
                            <p className="hmk_mobile_pointstore-alert-message">{alertMessage}</p>
                        </div>
                        <button
                            className="hmk_mobile_pointstore-alert-button"
